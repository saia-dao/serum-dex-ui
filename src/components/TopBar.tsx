          ...
          <Menu.Item key={tradePageUrl} style={{ margin: '0 10px 0 20px' }}>
            ...
            <Menu.SubMenu title="SHIP">
                ...
                <Menu.ItemGroup title="X-SMALL">
                    ...
                    <Menu.Item key="8nqjw5UVN65GyfdqiXnfJNbDVBgbk8RpFFd7uACXenbx">FIMBUL LOWBIE | FBLLOW/ATLAS</Menu.Item>
                    <Menu.Item key="8PDFK6EMZo5TB4uC6JKr9jETB7FRD5SRo2Q8661T9Voo">FIMBUL LOWBIE | FBLLOW/USDC</Menu.Item>
                </Menu.ItemGroup>
                <Menu.ItemGroup title="LARGE">
                    ...
                    <Menu.Item key="287f9V8JReL3bXhQsM6CPb5C5ARcxCMLygLajN9iUsMZ">RAINBOW ARC | ARC/ATLAS</Menu.Item>
                    <Menu.Item key="Gcig89WudHQPcVWyY7KRkRmJQNQEynskJfZ3yUR6r1VU">RAINBOW ARC | ARC/USDC</Menu.Item>
                </Menu.ItemGroup>
                <Menu.ItemGroup title="SMALL">
                    ...
                    <Menu.Item key="D67jgoRefKgFHNxwyFma4uBFANL6LgbT5Ye5oZHFYMzH">OGRIKA MIK | OGKAMK/ATLAS</Menu.Item>
                    <Menu.Item key="5QGZfnsebTNTfA1iS6X2YunLmCY2hby4suVK7rP6uydL">OGRIKA MIK | OGKAMK/USDC</Menu.Item>
                    <Menu.Item key="67UPc3C4RStjBn1pZUiyvHsaG6XQ5GgKnu9ec4WCQgQm">BUSAN THRILL OF LIFE | THRILL/ATLAS</Menu.Item>
                    <Menu.Item key="HRoNCkNSkiEQyv4kTFG1wWPZEK4ohY1QWUnLJXEyUSQW">BUSAN THRILL OF LIFE | THRILL/USDC</Menu.Item>
                </Menu.ItemGroup>
                ...
                <Menu.ItemGroup title="CAPITAL">
                    ...
                    <Menu.Item key="DwsBGKJZ9ysqe3yzxmcEi1Ft6CipdgJ3NRqRysw8DYYG">VZUS BALLAD | VZUSBA/ATLAS</Menu.Item>
                    <Menu.Item key="DY3rhF7MnwpzRy2gWPit9bkS6hQfSpFmx1SrYJaw18Aq">VZUS BALLAD | VZUSBA/USDC</Menu.Item>
                </Menu.ItemGroup>
                <Menu.ItemGroup title="XX-SMALL">
                    ...
                    <Menu.Item key="5xdJFqr5Au4kgGpfoQz9u1fpHhTWoHi4smRB1xxMM4CN">FIMBUL AIRBIKE | FBLAIR/ATLAS</Menu.Item>
                    <Menu.Item key="BDNE4EKMjcEmqEvAxaJ8huSXnhsYbPJTzR82Hb8GBWg4">FIMBUL AIRBIKE | FBLAIR/USDC</Menu.Item>
                    <Menu.Item key="3obvzbhuUWfBWKU4hxsCZKuTqm7tQXToRCTxtL2uyppY">FIMBUL ECOS UNIBOMBA | FBLEUN/ATLAS</Menu.Item>
                    <Menu.Item key="Aqdd4qvoXTqJ1EmM9RMY512TKrz6BJzGD3wWAtyWanmn">FIMBUL ECOS UNIBOMBA | FBLEUN/USDC</Menu.Item>
                </Menu.ItemGroup>
            </Menu.SubMenu>
